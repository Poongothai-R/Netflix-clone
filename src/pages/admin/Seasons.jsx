...
import SeasonItems from "../../components/admin/SeasonItems";
import { useCategory } from "../../state/useCategory";
import SeasonAdd from "../../components/admin/SeasonAdd";
    ...
    <div>
      ...
      {status === 1 && (
        <div id="seasonpage">
          ...
          <Link to={"/tvshows"} className="back-btn">
            Go Back
          </Link>
        </div>
      )}
